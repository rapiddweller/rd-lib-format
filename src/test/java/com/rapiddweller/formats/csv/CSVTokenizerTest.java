...
import com.rapiddweller.formats.csv.CSVTokenType;
import com.rapiddweller.formats.csv.CSVTokenizer;
...
public class CSVTokenizerTest {
    ...
    public void testFile() throws IOException {
        CSVTokenizer tokenizer = new CSVTokenizer("file://com/rapiddweller/formats/csv/names.csv", ',');
