...
public class XMLComparatorTest {
  ...
  public void testNoNamespaceVsNamespace() throws Exception {
    ...
    assertEquals(diffFactory.different("none", "http://databene.org/formats/xml/compare/xx", "element namespace", "/root/node[1]", "/root/xx:node"),
        diff.getDetail(0));
    assertEquals(diffFactory.different("none", "http://databene.org/formats/xml/compare/zz", "element namespace", "/root/node[2]", "/root/zz:node"),
        diff.getDetail(1));
  }
  ...
  public void testNamespacesDifferent() throws Exception {
    ...
    assertEquals(2, diff.getDetailCount());
    DiffDetail d1 = diffFactory
        .different("http://databene.org/formats/xml/compare/xx", "http://databene.org/formats/xml/compare/zz", "element namespace", "/root/xx:node",
            "/root/zz:node");
    assertEquals(d1, diff.getDetail(0));
    assertEquals(diffFactory
        .different("http://databene.org/formats/xml/compare/zz", "http://databene.org/formats/xml/compare/xx", "element namespace", "/root/zz:node",
            "/root/xx:node"), diff.getDetail(1));
  }
