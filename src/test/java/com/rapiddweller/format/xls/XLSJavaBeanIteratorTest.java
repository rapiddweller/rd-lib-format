...
public class XLSJavaBeanIteratorTest {
    ...
    public void testFlat() throws InvalidFormatException, IOException {
        XLSJavaBeanIterator<PersonWithAddress> iterator = new XLSJavaBeanIterator<PersonWithAddress>("com/rapiddweller/format/xls/person_lines.xls", "persons", true, PersonWithAddress.class);
    ...
    public void testTrailingNullHeaders() throws InvalidFormatException, IOException {
        XLSJavaBeanIterator<PersonWithAddress> iterator = new XLSJavaBeanIterator<PersonWithAddress>("com/rapiddweller/format/xls/person_lines_empty_headers_trailing.xls", "persons", true, PersonWithAddress.class);
        DataContainer<PersonWithAddress> wrapper = new DataContainer<PersonWithAddress>();
        assertNotNull(iterator.next(wrapper));
        assertContent("Alice", 23, TimeUtil.date(2011, 0, 1), wrapper);
        assertNotNull(iterator.next(wrapper));
    ...
    public void testOneToOneAssociation() throws InvalidFormatException, IOException {
        XLSJavaBeanIterator<PersonWithAddress> iterator = new XLSJavaBeanIterator<PersonWithAddress>("com/rapiddweller/format/xls/persons_with_address.xls", "persons", true, PersonWithAddress.class);
        DataContainer<PersonWithAddress> wrapper = new DataContainer<PersonWithAddress>();
        assertNotNull(iterator.next(wrapper));
    ...
    public void testOneToManyAssociation() throws InvalidFormatException, IOException {
        XLSJavaBeanIterator<PersonWithAddress> iterator = new XLSJavaBeanIterator<PersonWithAddress>("com/rapiddweller/format/xls/persons_with_addresses.xls", "persons", true, PersonWithAddress.class);
        DataContainer<PersonWithAddress> wrapper = new DataContainer<PersonWithAddress>();
        assertNotNull(iterator.next(wrapper));
