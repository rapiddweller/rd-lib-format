...
public class RegexParser extends Parser {
  ...
  public static final String[] tokenNames = new String[] {
      "<invalid>", "<EOR>", "<DOWN>", "<UP>", "PREDEFINEDCLASS", "ALPHANUM", "SPECIALCHARACTER", "ESCAPEDCHARACTER", "NONTYPEABLECHARACTER",
      "OCTALCHAR", "HEXCHAR", "CODEDCHAR", "SIMPLEQUANTIFIER", "INT", "GROUP", "CHOICE", "SEQUENCE", "FACTOR", "CLASS", "RANGE", "INCL", "EXCL",
      "QUANT", "LETTER", "DIGIT", "OCTALDIGIT", "HEXDIGIT", "LBRACE", "RBRACE", "LBRACKET", "RBRACKET", "'^'", "'$'", "'|'", "'-'", "'('", "')'",
      "','"
  };
  /**
   * The constant QUANT.
  ...
  /**
   * Expression regex parser . expression return.
   *
   * @return the regex parser . expression return
   * @throws RecognitionException the recognition exception
   */
// $ANTLR start "expression"
    ...
    try {
      ...
      // com/rapiddweller/regex/antlr/Regex.g:104:4: ( '^' )? choice ( '$' )?
      {
        ...
        switch (alt1) {
          ...
          {
            char_literal1 = (Token) match(input, 31, FOLLOW_31_in_expression78);
            if (state.failed) {
              return retval;
            }
        ...
        if (state.backtracking == 0) {
          adaptor.addChild(root_0, choice2.getTree());
        }
        ...
        switch (alt2) {
          case 1:
            // com/rapiddweller/regex/antlr/Regex.g:0:0: '$'
          {
            char_literal3 = (Token) match(input, 32, FOLLOW_32_in_expression84);
            if (state.failed) {
              return retval;
            }
  ...
  /**
   * Choice regex parser . choice return.
   *
   * @return the regex parser . choice return
   * @throws RecognitionException the recognition exception
   */
// $ANTLR start "choice"
    ...
    try {
      ...
      switch (alt4) {
          ...
          // com/rapiddweller/regex/antlr/Regex.g:107:4: sequence ( '|' sequence )+
        {
          ...
          if (state.backtracking == 0) {
            stream_sequence.add(sequence4.getTree());
          }
          ...
          do {
            ...
            switch (alt3) {
              ...
              {
                char_literal5 = (Token) match(input, 33, FOLLOW_33_in_choice98);
                if (state.failed) {
                  return retval;
                }
                if (state.backtracking == 0) {
                ...
                if (state.backtracking == 0) {
                  stream_sequence.add(sequence6.getTree());
                }
          ...
          // com/rapiddweller/regex/antlr/Regex.g:108:4: sequence
        {
          ...
          if (state.backtracking == 0) {
            adaptor.addChild(root_0, sequence7.getTree());
          }
      ...
      if (state.backtracking > 0) {
        memoize(input, 2, choice_StartIndex);
      }
    }
    return retval;
  }
  ...
  /**
   * Sequence regex parser . sequence return.
   *
   * @return the regex parser . sequence return
   * @throws RecognitionException the recognition exception
   */
// $ANTLR start "sequence"
  ...
  public final RegexParser.sequence_return sequence() throws RecognitionException {
    ...
    try {
          ...
          do {
            ...
            switch (alt5) {
                ...
                // com/rapiddweller/regex/antlr/Regex.g:0:0: factor
              {
                ...
                if (state.backtracking == 0) {
                  stream_factor.add(factor9.getTree());
                }
      ...
      if (state.backtracking > 0) {
        memoize(input, 3, sequence_StartIndex);
      }
    }
    return retval;
  }
  ...
  /**
   * Factor regex parser . factor return.
   *
   * @return the regex parser . factor return
   * @throws RecognitionException the recognition exception
   */
// $ANTLR start "factor"
    ...
    try {
      ...
      switch (alt7) {
          ...
          // com/rapiddweller/regex/antlr/Regex.g:114:10: atom quantifier
        {
          ...
          if (state.backtracking == 0) {
            stream_quantifier.add(quantifier12.getTree());
          }
      ...
      if (state.backtracking > 0) {
        memoize(input, 4, factor_StartIndex);
      }
    }
    return retval;
  }
  ...
  /**
   * Atom regex parser . atom return.
   *
   * @return the regex parser . atom return
   * @throws RecognitionException the recognition exception
   */
// $ANTLR start "atom"
    ...
    try {
      ...
      switch (alt8) {
          ...
          // com/rapiddweller/regex/antlr/Regex.g:117:8: singlechar
        {
          ...
          if (state.backtracking == 0) {
            adaptor.addChild(root_0, singlechar14.getTree());
          }
          ...
          // com/rapiddweller/regex/antlr/Regex.g:118:4: group
        {
          ...
          if (state.backtracking == 0) {
            adaptor.addChild(root_0, group15.getTree());
          }
  ...
  /**
   * Singlechar regex parser . singlechar return.
   *
   * @return the regex parser . singlechar return
   * @throws RecognitionException the recognition exception
   */
// $ANTLR start "singlechar"
    ...
    try {
      ...
      switch (alt9) {
          ...
          // com/rapiddweller/regex/antlr/Regex.g:122:4: classchar
        {
          ...
          if (state.backtracking == 0) {
            root_0 = (Object) adaptor.becomeRoot(classchar16.getTree(), root_0);
          }
          ...
          // com/rapiddweller/regex/antlr/Regex.g:123:4: '-'
        {
          ...
          char_literal17 = (Token) match(input, 34, FOLLOW_34_in_singlechar197);
          if (state.failed) {
            return retval;
          }
          if (state.backtracking == 0) {
          ...
          // com/rapiddweller/regex/antlr/Regex.g:124:4: charclass
        {
          ...
          if (state.backtracking == 0) {
            adaptor.addChild(root_0, charclass18.getTree());
          }
          ...
          // com/rapiddweller/regex/antlr/Regex.g:125:4: PREDEFINEDCLASS
        {
          ...
          PREDEFINEDCLASS19 = (Token) match(input, PREDEFINEDCLASS, FOLLOW_PREDEFINEDCLASS_in_singlechar208);
          if (state.failed) {
            return retval;
          }
          if (state.backtracking == 0) {
      ...
      if (state.backtracking > 0) {
        memoize(input, 6, singlechar_StartIndex);
      }
    }
    return retval;
  }
  ...
  /**
   * Classchar regex parser . classchar return.
   *
   * @return the regex parser . classchar return
   * @throws RecognitionException the recognition exception
   */
// $ANTLR start "classchar"
  ...
  public final RegexParser.classchar_return classchar() throws RecognitionException {
    ...
    try {
      ...
      if (state.backtracking > 0) {
        memoize(input, 7, classchar_StartIndex);
      }
    }
    return retval;
  }
  ...
  /**
   * Charclass regex parser . charclass return.
   *
   * @return the regex parser . charclass return
   * @throws RecognitionException the recognition exception
   */
// $ANTLR start "charclass"
  ...
  public final RegexParser.charclass_return charclass() throws RecognitionException {
    ...
    try {
      ...
      {
        char_literal21 = (Token) match(input, LBRACKET, FOLLOW_LBRACKET_in_charclass276);
        if (state.failed) {
          return retval;
        }
        if (state.backtracking == 0) {
          stream_LBRACKET.add(char_literal21);
        }
        ...
        switch (alt10) {
            ...
            // com/rapiddweller/regex/antlr/Regex.g:0:0: includedelements
          {
            ...
            if (state.backtracking == 0) {
              stream_includedelements.add(includedelements22.getTree());
            }
        ...
        switch (alt11) {
          ...
          {
            char_literal23 = (Token) match(input, 31, FOLLOW_31_in_charclass282);
            if (state.failed) {
              return retval;
            }
            if (state.backtracking == 0) {
            ...
            if (state.backtracking == 0) {
              stream_excludedelements.add(excludedelements24.getTree());
            }
        ...
        char_literal25 = (Token) match(input, RBRACKET, FOLLOW_RBRACKET_in_charclass288);
        if (state.failed) {
          return retval;
        }
        if (state.backtracking == 0) {
          stream_RBRACKET.add(char_literal25);
        }
      ...
      if (state.backtracking > 0) {
        memoize(input, 8, charclass_StartIndex);
      }
    }
    return retval;
  }
  ...
  /**
   * The type Includedelements return.
   */
  ...
  /**
   * Includedelements regex parser . includedelements return.
   *
   * @return the regex parser . includedelements return
   * @throws RecognitionException the recognition exception
   */
// $ANTLR start "includedelements"
  ...
  public final RegexParser.includedelements_return includedelements() throws RecognitionException {
    ...
    try {
        ...
        do {
          ...
          switch (alt12) {
              ...
              // com/rapiddweller/regex/antlr/Regex.g:0:0: classelement
            {
              ...
              if (state.backtracking == 0) {
                adaptor.addChild(root_0, classelement26.getTree());
              }
      ...
      if (state.backtracking > 0) {
        memoize(input, 9, includedelements_StartIndex);
      }
    }
    return retval;
  }
  ...
  /**
   * The type Excludedelements return.
   */
  ...
  /**
   * Excludedelements regex parser . excludedelements return.
   *
   * @return the regex parser . excludedelements return
   * @throws RecognitionException the recognition exception
   */
// $ANTLR start "excludedelements"
  ...
  public final RegexParser.excludedelements_return excludedelements() throws RecognitionException {
    ...
    try {
        ...
        do {
          ...
          switch (alt13) {
              ...
              // com/rapiddweller/regex/antlr/Regex.g:0:0: classelement
            {
              ...
              if (state.backtracking == 0) {
                adaptor.addChild(root_0, classelement27.getTree());
              }
      ...
      if (state.backtracking > 0) {
        memoize(input, 10, excludedelements_StartIndex);
      }
    }
    return retval;
  }
  ...
  /**
   * Classelement regex parser . classelement return.
   *
   * @return the regex parser . classelement return
   * @throws RecognitionException the recognition exception
   */
// $ANTLR start "classelement"
    ...
    try {
      ...
      switch (alt14) {
          ...
          // com/rapiddweller/regex/antlr/Regex.g:151:4: classchar
        {
          ...
          if (state.backtracking == 0) {
            adaptor.addChild(root_0, classchar28.getTree());
          }
          ...
          // com/rapiddweller/regex/antlr/Regex.g:152:4: charrange
        {
          ...
          if (state.backtracking == 0) {
            adaptor.addChild(root_0, charrange29.getTree());
          }
          ...
          // com/rapiddweller/regex/antlr/Regex.g:153:4: PREDEFINEDCLASS
        {
          ...
          PREDEFINEDCLASS30 = (Token) match(input, PREDEFINEDCLASS, FOLLOW_PREDEFINEDCLASS_in_classelement355);
          if (state.failed) {
            return retval;
          }
          if (state.backtracking == 0) {
      ...
      if (state.backtracking > 0) {
        memoize(input, 11, classelement_StartIndex);
      }
    }
    return retval;
  }
  ...
  /**
   * Charrange regex parser . charrange return.
   *
   * @return the regex parser . charrange return
   * @throws RecognitionException the recognition exception
   */
// $ANTLR start "charrange"
  ...
  public final RegexParser.charrange_return charrange() throws RecognitionException {
    ...
    try {
      ...
      // com/rapiddweller/regex/antlr/Regex.g:156:12: classchar '-' classchar
      {
        ...
        if (state.backtracking == 0) {
          stream_classchar.add(classchar31.getTree());
        }
        char_literal32 = (Token) match(input, 34, FOLLOW_34_in_charrange366);
        if (state.failed) {
          return retval;
        }
        if (state.backtracking == 0) {
        ...
        if (state.backtracking == 0) {
          stream_classchar.add(classchar33.getTree());
        }
      ...
      if (state.backtracking > 0) {
        memoize(input, 12, charrange_StartIndex);
      }
    }
    return retval;
  }
  ...
  /**
   * Group regex parser . group return.
   *
   * @return the regex parser . group return
   * @throws RecognitionException the recognition exception
   */
// $ANTLR start "group"
  ...
  public final RegexParser.group_return group() throws RecognitionException {
    ...
    try {
      ...
      {
        char_literal34 = (Token) match(input, 35, FOLLOW_35_in_group385);
        if (state.failed) {
          return retval;
        }
        if (state.backtracking == 0) {
        ...
        char_literal36 = (Token) match(input, 36, FOLLOW_36_in_group389);
        if (state.failed) {
          return retval;
        }
        if (state.backtracking == 0) {
  ...
  /**
   * Quantifier regex parser . quantifier return.
   *
   * @return the regex parser . quantifier return
   * @throws RecognitionException the recognition exception
   */
    ...
    try {
      ...
      switch (alt15) {
          ...
          // com/rapiddweller/regex/antlr/Regex.g:161:4: SIMPLEQUANTIFIER
        {
          ...
          SIMPLEQUANTIFIER37 = (Token) match(input, SIMPLEQUANTIFIER, FOLLOW_SIMPLEQUANTIFIER_in_quantifier406);
          if (state.failed) {
            return retval;
          }
          if (state.backtracking == 0) {
        ...
        {
          char_literal38 = (Token) match(input, LBRACE, FOLLOW_LBRACE_in_quantifier411);
          if (state.failed) {
            return retval;
          }
          if (state.backtracking == 0) {
            stream_LBRACE.add(char_literal38);
          }

          min = (Token) match(input, INT, FOLLOW_INT_in_quantifier415);
          if (state.failed) {
            return retval;
          }
          if (state.backtracking == 0) {
          ...
          char_literal39 = (Token) match(input, 37, FOLLOW_37_in_quantifier417);
          if (state.failed) {
            return retval;
          }
          if (state.backtracking == 0) {
          ...
          max = (Token) match(input, INT, FOLLOW_INT_in_quantifier421);
          if (state.failed) {
            return retval;
          }
          if (state.backtracking == 0) {
          ...
          char_literal40 = (Token) match(input, RBRACE, FOLLOW_RBRACE_in_quantifier423);
          if (state.failed) {
            return retval;
          }
          if (state.backtracking == 0) {
            stream_RBRACE.add(char_literal40);
          }
        ...
        {
          char_literal41 = (Token) match(input, LBRACE, FOLLOW_LBRACE_in_quantifier440);
          if (state.failed) {
            return retval;
          }
          if (state.backtracking == 0) {
            stream_LBRACE.add(char_literal41);
          }

          INT42 = (Token) match(input, INT, FOLLOW_INT_in_quantifier442);
          if (state.failed) {
            return retval;
          }
          if (state.backtracking == 0) {
          ...
          char_literal43 = (Token) match(input, 37, FOLLOW_37_in_quantifier444);
          if (state.failed) {
            return retval;
          }
          if (state.backtracking == 0) {
          ...
          char_literal44 = (Token) match(input, RBRACE, FOLLOW_RBRACE_in_quantifier446);
          if (state.failed) {
            return retval;
          }
          if (state.backtracking == 0) {
            stream_RBRACE.add(char_literal44);
          }
        ...
        {
          char_literal45 = (Token) match(input, LBRACE, FOLLOW_LBRACE_in_quantifier459);
          if (state.failed) {
            return retval;
          }
          if (state.backtracking == 0) {
            stream_LBRACE.add(char_literal45);
          }

          INT46 = (Token) match(input, INT, FOLLOW_INT_in_quantifier461);
          if (state.failed) {
            return retval;
          }
          if (state.backtracking == 0) {
          ...
          char_literal47 = (Token) match(input, RBRACE, FOLLOW_RBRACE_in_quantifier463);
          if (state.failed) {
            return retval;
          }
          if (state.backtracking == 0) {
      ...
      if (state.backtracking > 0) {
        memoize(input, 14, quantifier_StartIndex);
      }
    }
    return retval;
  }
      ...
      do {
        ...
        switch (alt16) {
          case 1:
            // com/rapiddweller/regex/antlr/Regex.g:107:14: '|' sequence
          {
            match(input, 33, FOLLOW_33_in_synpred4_Regex98);
            if (state.failed) {
              return;
            }
